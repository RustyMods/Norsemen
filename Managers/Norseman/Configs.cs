...
public partial class Norseman
{
    public void SetupConfigs()
    {
        ...
        configs.conditionalSets = ConfigManager.config(name, "Conditional Sets",
            ...
            new ConfigDescription("Set conditional random sets by unique name", null,
        ...
        configs.conditionalItems = ConfigManager.config(name, "Conditional Items",
            ...
            new ConfigDescription("Set conditional items by unique name", null,
                StringList.attributes));

        configs.tamingTime =
            ConfigManager.config(name, "Taming Duration", 1800f, "Set time it take to tame, in seconds");
