...
public partial class Viking
{
    ...
    private static class SE_Harpooned_UpdateStatusEffect_Patch
    {
        ...
        {
            if (!__instance.m_character || !__instance.m_attacker || __instance.m_attacker is not Viking) return true;
        ...
        private static void UpdateSE_Harpooned(SE_Harpooned __instance, float dt)
        {
            ...
            float v = Vector3.Distance(__instance.m_attacker.transform.position, __instance.m_character.transform.position);
